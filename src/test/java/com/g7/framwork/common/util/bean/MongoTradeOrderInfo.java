 ...
 * @author dreamyao
 */
public class MongoTradeOrderInfo implements Serializable {

    private static final long serialVersionUID = -7375948735153255875L;
    ...
    private TargetUserInfo userInfo;
    ...
    public TargetUserInfo getUserInfo() {
        return userInfo;
    }

    public void setUserInfo(TargetUserInfo userInfo) {
